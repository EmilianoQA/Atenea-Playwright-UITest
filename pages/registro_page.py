...
class RegistroPage:
    ...
    def __init__(self, page: Page):
        ...
        self.input_confirmar_password = page.get_by_role(
            "textbox", name="Confirmar contraseña"
        )
        self.checkbox_terminos = page.get_by_role(
            "checkbox", name="Acepto los Términos y"
        )
        self.boton_crear_cuenta = page.get_by_role("button", name="Crear cuenta")
        self.cuenta_creada_heading = page.get_by_role(
            "heading", name="¡Tu cuenta está lista!"
        )
        ...
        self.acceso_estudiantes_heading = page.get_by_role(
            "heading", name="Acceso de Estudiantes"
        )
        self.input_email_registrado = page.get_by_role(
